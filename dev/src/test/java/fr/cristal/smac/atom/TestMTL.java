...
public class TestMTL {
	...
	public void test() {
		...
		Order orders[] = {
				...
				// Fixe 1 prix de 3 à 1000; le Market transforme son résidu en Limit Bid qute 2
				// à 1000
				...
				// TEST 5 :Le MTL laisse un résidu qui ne match pas le suivant (contrairement à
				// un Market)
				new LimitOrder(obName, "-", LimitOrder.BID, 3, (long) 1000),
				new LimitOrder(obName, "-", LimitOrder.BID, 3, (long) 800),
				new MarketToLimitOrder(obName, "u", LimitOrder.ASK, 10),
				// Fixe un prix de 3 à 1000, laisse un résidu de 7 à 1000 en ASK, face à un BID
				// non matche
